                    ...
                    <div class="collapse navbar-collapse " id="navbarSupportedContent">
                        <ul class="navbar-nav mb-sm-2 col-sm">
                            ...
                            <li class="nav-item col-sm d-flex  flex-grow-1 <?php if (!empty($corder)) {
                                ...
                                <a class="nav-link active " style="color:rgba(255, 255, 255,0.5);" href="/showcart">
                                    <button type="sumbit" class="btn btn-sm btn-light" name="cart">
                                        <i class="fa-solid fa-cart-shopping" style="font-size: 0.9rem!important;"></i> <span class="badge 
                                        @isset($carts)
                                         @if ($carts->isNotEmpty())
                                          {{ 'bg-success' }}
