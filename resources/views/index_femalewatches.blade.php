...
$femaleobj = new Customer();
$femalewatches = $femaleobj->getfemalewatches();
...
<div class='row'>
  <?php
  if (count($femalewatches) > 0) {
    foreach ($femalewatches as $key => $value) {
  ?><div class="col-sm-3 p-sm-3" style="justify-content:center">
